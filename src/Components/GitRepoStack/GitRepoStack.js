...
import "./GitRepoStack.scss";
import {Fade} from "react-reveal";
import {FileFormatSize} from "../../Utils/FileFormatSize";

export default function GitRepoStack({repo}) {
        ...
        >
          ...
          <div className="repo-stats">
            ...
            <div className="repo-right-stat">
              <p>{FileFormatSize(repo.node.diskUsage)}</p>
            </div>
          </div>
        </div>
      </div>
